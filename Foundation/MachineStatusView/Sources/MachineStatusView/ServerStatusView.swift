    ...
    struct BaseStatusView: View {
        ...
        var body: some View {
            VStack(alignment: .leading, spacing: 16) {
                ...
                Text(L10n.tr("Generated by Rayon, updated in real-time."))
        ...
        public var body: some View {
            VStack {
                HStack {
                    ...
                    Text(L10n.tr("System").uppercased())
